...
TEST(BitcoinPrimitives,VariableLengthInteger)
{
    ...
    EXPECT_EQ(1, static_cast<std::uint64_t>(l1));
    ...
    EXPECT_EQ(4321, static_cast<std::uint64_t>(l2));
    ...
    EXPECT_EQ(987654321, static_cast<std::uint64_t>(l3));
    ...
    EXPECT_EQ(987654321987654321, static_cast<std::uint64_t>(l4));
